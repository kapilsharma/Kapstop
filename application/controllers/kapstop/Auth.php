...
/**
 * This is actually 'Tank Auth' controller, updated a bit to work with KTemplate.
...
class Auth extends KT_Controller
{
	...
	function index()
	{
		if ($message = $this->session->flashdata('message')) {
        	//TODO: Load general message view through KTemplate.
			$this->load->view('auth/general_message', array('message' => $message));
		} else {
			redirect('/kapstop/auth/login/');
		}
	}
	...
	function login()
	{
		if ($this->tank_auth->is_logged_in()) {
        	//TODO: User is logged in, redirect to user home.
			redirect('');
		} elseif ($this->tank_auth->is_logged_in(FALSE)) {
        	//User is logged in but not activated. Resend authentication mail.
			redirect('/kapstop/auth/send_again/');
		} else {
			...
			if ($this->form_validation->run()) {								// validation ok
				if ($this->tank_auth->login(
						...
						$data['login_by_email'])) {
                    //ToDo: Login successful. Redirect to dashboard.
					redirect('');
				} else {
